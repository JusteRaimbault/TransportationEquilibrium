...
\textit{Session Transportation Modeling}\\\smallskip % TODO session id
5th September 2016
}
...
$\rightarrow$ in theoretical literature, as for example \cite{leurent2014user}

\medskip

$\rightarrow$ in real-world application, such as the MODUS model for Parisian region
...
\textbf{Research Objective : } \textit{Investigate empirically the spatio-temporal stationarity of flows, combining different complementary quantitative approaches on a concrete dataset}

\bigskip

$\rightarrow$ Construction of a real-time dataset for Paris region on 6 month by data crawling
...
\textit{Very high spatial variability on 10min time interval, here on 11/02/2016 00:06}

\bigskip

\includegraphics[width=0.5\textwidth]{figures/gr21}\hfill
\includegraphics[width=0.5\textwidth]{figures/gr22}
